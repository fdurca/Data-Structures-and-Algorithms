public class TestDict {
	...
	/*
	 ** Test program for the Dictionary class. This program WILL NOT COMPILE if your
	 * insert or remove methods do not throw a DictionaryException.
	 */
	...
	public static void main(String[] args) {
		...
		if (test[10])
			if (collisions >= 6000) {
				...
				System.out.println("   Test 10 succeeded" + collisions);
	}
}
