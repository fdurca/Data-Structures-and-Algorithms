 ...
 * It serves as an inverted positional index. Every word is mapped, through its
 * hash value, to a specific position in the table. Every position in the table
 * contains a binary search tree for every word that is mapped to this place.
 * 
 *
 */
